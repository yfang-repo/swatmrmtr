...
!
  ...
  PetscReal :: T_kelvin, RT, alpha, A, B
  ...
  A = coeff_a*alpha*(P/Pc_eff)/(T_kelvin/Tc_eff)**2
  B = coeff_b*(P/Pc_eff)/(T_kelvin/Tc_eff)
  ...
  ! Nickalls 1993,  A new approach to solving the cubic Cardans solution revealed
  ! you get three-real-roots if yn^2 < hn^2, which is the case here
