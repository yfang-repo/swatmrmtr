...
!YFang - dissolved CO2 and N2
      real, dimension (:), allocatable :: discarb,disnit
...
! YFang
! storage zone species (id,step)
      real, dimension (:,:), allocatable :: hhimmobile
! storage zone species (id,rch)
      real, dimension (:,:), allocatable :: cimmobile
! nexss related (rch)
      real*8, dimension(:,:), allocatable :: qs_v !m^3/s
      real*8, dimension(:,:), allocatable :: qs_l
      real*8, dimension(:,:), allocatable :: ts_v !hr
      real*8, dimension(:,:), allocatable :: ts_l
      real*8, dimension(:,:), allocatable :: xsarea !m^2
!
...
! hourly time step (by AVG)
      ...
      real, dimension (:), allocatable :: hco2,hn2
